        ...
        <section class="pt-120 pb-120">
            <div class="container">
                <div class="position-relative">
                    <img src="{{ asset('/assets/imgs/theme/plane.png') }}" alt=""
                        class="shape-arrow-login d-none d-lg-block">
                    <div class="row">
                                    ...
                                    <div class="checkbox">
                                        <div class="custome-checkbox">
                                            <input class="form-check-input" type="checkbox" name="checkbox"
                                                id="createaccount">
                                            <label class="form-check-label label_info fw-700 text-grey-100 font-md"><span>I
                                                    agree to terms & Policy.</span></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button class="btn btn-lg bg-dark text-white text-uppercase" type="submit">Submit &
                                        register</button>
                                </div>
                            </form>
                        </div>
