        ...
        <div class="container single-content">
            ...
            <article class="entry-wraper mb-50">
                ...
                <div class="entry-main-content wow fadeIn animated">
                    ...
                    <p>Thanks sniffed in hello after in foolhardy and some far purposefully much one at the much conjointly leapt skimpily that quail sheep some goodness <a href="{{ url("#") }}">nightingale</a> the instead exited expedient up far ouch mellifluous altruistic and and lighted more instead much when ferret but the.</p>
                    <figure class="wp-block-gallery columns-3 wp-block-image">
                        <ul class="blocks-gallery-grid">
                            <li class="blocks-gallery-item"><a href="{{ url("#") }}"><img class="border-radius-5" src="{{ asset("/assets/imgs/news/thumb-2.jpg") }}" alt=""></a></li>
                            <li class="blocks-gallery-item"><a href="{{ url("#") }}"><img class="border-radius-5" src="{{ asset("/assets/imgs/news/thumb-3.jpg") }}" alt=""></a></li>
                            <li class="blocks-gallery-item"><a href="{{ url("#") }}"><img class="border-radius-5" src="{{ asset("/assets/imgs/news/thumb-4.jpg") }}" alt=""></a></li>
                        </ul>
                        <figcaption> <i class="ti-credit-card mr-5"></i>Image credit: Behance </figcaption>
                    </figure>
                    <hr class="section-divider">
                    <p>Yet more some certainly yet alas abandonedly whispered <a href="{{ url("#") }}">intriguingly</a><sup><a href="{{ url("#") }}">[2]</a></sup> well extensive one howled talkative admonishingly below a rethought overlaid dear gosh activated less <a href="{{ url("#") }}">however</a> hawk yet oh scratched ostrich some outside crud irrespective lightheartedly and much far amenably that the elephant since when.</p>
                    <h2>The Guitar Legends</h2>
                    <p>Furrowed this in the upset <a href="{{ url("#") }}">some across</a><sup><a href="{{ url("#") }}">[3]</a></sup> tiger oh loaded house gosh whispered <a href="{{ url("#") }}">faltering alas</a><sup><a href="{{ url("#") }}">[4]</a></sup> ouch cuckoo coward in scratched undid together bit fumblingly so besides salamander heron during the jeepers hello fitting jauntily much smoothly globefish darn blessedly far so along bluebird leopard and.</p>
                    <blockquote>
                        <p>Integer eu faucibus <a href="{{ url("#") }}">dolor</a><sup><a href="{{ url("#") }}">[5]</a></sup>. Ut venenatis tincidunt diam elementum imperdiet. Etiam accumsan semper nisl eu congue. Sed aliquam magna erat, ac eleifend lacus rhoncus in.</p>
                    </blockquote>
                ...
                <div class="entry-bottom mt-50 mb-30 wow fadeIn animated">
                    ...
                    <div class="single-social-share clearfix wow fadeIn animated mb-15 w-50 w-sm-100">
                        <ul class="header-social-network d-inline-block list-inline float-md-right mt-md-0 mt-4">
                            ...
                            <li class="list-inline-item"><a class="social-icon fb text-xs-center" target="_blank" href="{{ url("#") }}"><i class="elegant-icon social_facebook"></i></a></li>
                            <li class="list-inline-item"><a class="social-icon tw text-xs-center" target="_blank" href="{{ url("#") }}"><i class="elegant-icon social_twitter "></i></a></li>
                            <li class="list-inline-item"><a class="social-icon pt text-xs-center" target="_blank" href="{{ url("#") }}"><i class="elegant-icon social_pinterest "></i></a></li>
                        </ul>
                    </div>
                </div>
                <!--author box-->
                <div class="author-bio mt-50 border-radius-10 bg-white wow fadeIn animated">
                    <div class="author-image mb-md-30">
                        <a href="{{ url("/author") }}"><img src="{{ asset("/assets/imgs/authors/author-details.jpg") }}" alt="" class="avatar"></a>
                    </div>
                    <div class="author-info">
                        <h4 class="font-weight-bold mb-20"><span class="vcard author"><span class="fn"><a href="{{ url("/author") }}" title="Posted by Barbara Cartland" rel="author">Barbara Cartland</a></span></span>
                        </h4>
                        ...
                        <div class="author-social-small">
                            <ul class="author-social-icons">
                                <li class="author-social-link-facebook"><a href="{{ url("#") }}" target="_blank"><i class="elegant-icon social_facebook"></i></a></li>
                                <li class="author-social-link-twitter"><a href="{{ url("#") }}" target="_blank"><i class="elegant-icon social_twitter "></i></a></li>
                                <li class="author-social-link-pinterest"><a href="{{ url("#") }}" target="_blank"><i class="elegant-icon  social_pinterest "></i></a></li>
                                <li class="author-social-link-instagram"><a href="{{ url("#") }}" target="_blank"><i class="elegant-icon social_instagram "></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <ul class="list-post">
                                ...
                                <div class="d-flex latest-small-thumb">
                                    ...
                                    <div class="post-content media-body align-self-center">
                                        <h5 class="post-title mb-15 text-limit-3-row font-medium">
                                            <a href="{{ url("single.html") }}" tabindex="0">9 Things I Love About Shaving My Head During Quarantine</a>
                                        </h5>
                            ...
                            <li>
                                <div class="d-flex latest-small-thumb">
                                    ...
                                    <div class="post-content media-body align-self-center">
                                        <h5 class="post-title mb-15 text-limit-3-row font-medium">
                                            <a href="{{ url("single.html") }}" tabindex="0">Where to Score the Best Travel Deals on Cyber Monday</a>
                                        </h5>
                                        <div class="entry-meta meta-1 float-left font-sm">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="header-title-2 mb-65">
                                <h4 class="mb-0 text-grey-400 wow fadeIn  animated" style="visibility: visible; animation-name: fadeIn;">
                                    <img src="{{ asset("/assets/imgs/theme/svg/send.svg") }}" alt="">
                                    <span>Subscribe</span>
                                </h4>
                                <h3 class="font-heading wow fadeIn  animated" style="visibility: visible; animation-name: fadeIn;">to Our Newsletter</h3>
                            </div>
                            <form class="form-subcriber mt-30 d-flex wow fadeIn  animated" style="visibility: visible; animation-name: fadeIn;">
                                <input type="email" class="form-control bg-white font-small" placeholder="Enter your email">
                                <button class="btn bg-dark text-white" type="submit">Subscribe</button>
                            </form>
                        </div>
                    </div>
                    <img src="{{ asset("/assets/imgs/theme/sketch-1.png") }}" alt="" class="sketch-1 wow fadeIn  animated" style="visibility: visible; animation-name: fadeIn;">
                </div>
            </div>
        </section>
    </main>
