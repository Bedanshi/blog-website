                            ...
                            <div class="post-content p-30">
                                <div class="post-card-content">
                                    ...
                                    <h4 class="post-title mb-30">
                                        <a href="{{ url('single.html') }}">After a Few Dates, They Traveled to the Other
                                            Side of the World</a>
                                    </h4>
                        ...
                        <div class="post-card-1 large border-radius-10 hover-up">
                            ...
                            <div class="post-content p-30">
                                <div class="post-card-content">
                                    ...
                                    <h4 class="post-title mb-30">
                                        <a href="{{ url('single.html') }}">5 Kinds of Food-Shamers You Will Encounter (and
                                            How to Deal) </a>
                                    </h4>
                                    <div class="post-meta-2 font-md">
                                        <a href="{{ url('page-author.html') }}">
                        ...
                        <div class="post-card-1 large border-radius-10 hover-up">
                            ...
                            <div class="post-content p-30">
                                <div class="post-card-content">
                                    ...
                                    <h4 class="post-title mb-30">
                                        <a href="{{ url('single.html') }}">Runner with Autism Graces the Latest Cover of
                                            Women's Running </a>
                                    </h4>
                                    <div class="post-meta-2 font-md">
                                        <a href="{{ url('page-author.html') }}">
                        ...
                        <div class="post-card-1 large border-radius-10 hover-up">
                            ...
                            <div class="post-content p-30">
                                <div class="post-card-content">
                                    ...
                                    <h4 class="post-title mb-30">
                                        <a href="{{ url('single.html') }}">10 Snacks a Food Writer Packs for Day Hikes and
                                            Car Trips</a>
                                    </h4>
                                    <div class="post-meta-2 font-md">
                                        <a href="{{ url('page-author.html') }}">
                        ...
                        <div class="post-card-1 border-radius-10 hover-up">
                            ...
                            <div class="post-content p-30">
                                <div class="post-card-content">
                                    ...
                                    <h5 class="post-title font-md">
                                        <a href="{{ url('single.html') }}">Jessamyn Stanley's 5-Minute Yoga for
                                            Beginners</a>
                                    </h5>
                                </div>
                            </div>
                        ...
                        <div class="post-card-1 border-radius-10 hover-up">
                            ...
                            <div class="post-content p-30">
                                <div class="post-card-content">
                                    ...
                                    <h5 class="post-title font-md">
                                        <a href="{{ url('single.html') }}">How an MS Diagnosis Changed My Relationship
                                            With Food </a>
                                    </h5>
                                </div>
                            </div>
                        ...
                        <div class="post-card-1 border-radius-10 hover-up">
                            ...
                            <div class="post-content p-30">
                                <div class="post-card-content">
                                    ...
                                    <h5 class="post-title font-md">
                                        <a href="{{ url('single.html') }}">Where to Score the Best Travel Deals on Cyber
                                            Monday </a>
                                    </h5>
                                </div>
                            </div>
                        ...
                        <div class="post-card-1 border-radius-10 hover-up">
                            ...
                            <div class="post-content p-30">
                                <div class="post-card-content">
                                    ...
                                    <h5 class="post-title font-md">
                                        <a href="{{ url('single.html') }}">12 Best Books to Read at the Beach This Summer
                                        </a>
                                    </h5>
                                </div>
                            </div>
